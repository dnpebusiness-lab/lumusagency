        ...
        <div className="mx-auto max-w-[1400px] grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-8 font-display tracking-tightest leading-[1.05] text-3xl md:text-4xl">
              ...
              <br />
              <span className="italic text-gold">we&rsquo;ll come back with the questions</span>.
            </h2>
          ...
          <div className="lg:col-span-5 lg:border-l lg:border-[var(--border-gold)] lg:pl-12 flex flex-col gap-12">
            <ContactInfo />
            <WhatsAppWidget />
          </div>
        </div>
